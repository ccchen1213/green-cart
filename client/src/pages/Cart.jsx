    ...
    <div className="flex flex-col md:flex-row mt-16">
        ...
        {cartArray.map((product, index) => (
          ...
          >
            <div className="flex items-center md:gap-6 gap-3">
              <div onClick={()=>handleClick(product)} className="cursor-pointer w-24 h-24 flex items-center 
                ...
                <div className="font-normal text-gray-500/70">
                  ...
                  <div className="flex items-center">
                    ...
                    <select onChange={e => updateCartItem(product._id, Number(e.target.value))} 
                      className="outline-none" value={cartItems[product._id]}>
      ...
      <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
        ...
        <div className="mb-6">
          ...
          <select onChange={e => setPaymentOption(e.target.value)} className="w-full border border-gray-300 
            bg-white px-3 py-2 mt-2 outline-none">
        ...
        <button onClick={placeOrder} className="w-full py-3 mt-6 cursor-pointer bg-primary text-white font-medium 
